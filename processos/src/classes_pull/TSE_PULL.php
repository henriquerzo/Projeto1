...
class TSE_PULL extends ABSTRACT_PULL{
	...
	public function TSE_PULL($numero_processo){
	...
	public function pull(){
		...
		$url_post = 'http://www.tse.jus.br/sadJudSadpPush/ExibirDadosProcesso.do?nprot=' . $this->getNumeroProcesso() . '&comboTribunal=tse';
